 ...
 *  @brief Projeto de demonstração de um sistema embarcado multitarefa utilizando 
 *         o FreeRTOS na plataforma BitDogLab. O sistema controla de forma 
 *         concorrente um LED RGB que alterna entre as cores vermelho, verde e azul, 
 *         um buzzer que emite bipes periódicos, e dois botões que permitem 
 *         suspender ou retomar as tarefas do LED e do buzzer individualmente.
 *
 *  @file	    main.c
